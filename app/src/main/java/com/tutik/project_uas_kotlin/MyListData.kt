...
//Deklarasi Variable Database Reference & ArrayList dengan Parameter Class Model kita.
    ...
    private var dataRujukan = ArrayList<data_rujukan>()
...
//Mapping data pada DataSnapshot ke dalam objek mahasiswa
                            val rujukan =
                                snapshot.getValue(data_rujukan::class.java)
//Mengambil Primary Key, digunakan untuk proses Update/Delete
                            rujukan?.key = snapshot.key
                            dataRujukan.add(rujukan!!)
                        }
//Inisialisasi Adapter dan data Mahasiswa dalam bentuk Array
                        adapter = RecyclerViewAdapter(dataRujukan, this@MyListData)
...
//Membuat Underline pada Setiap Item Didalam List
    ...
    override fun onDeleteData(data: data_rujukan?, position: Int) {
